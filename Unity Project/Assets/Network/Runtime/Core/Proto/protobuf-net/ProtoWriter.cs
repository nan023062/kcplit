    ...
    public sealed class ProtoWriter : IDisposable
    {
        ...
        public static void WriteBytes(byte[] data, int offset, int length, ProtoWriter writer)
        {
            ...
            switch (writer.wireType)
            {
                ...
                case WireType.String:
					...
					#if OPTIMIZATION_NETWORK
					writer._destBuf.Write(data, (UInt32)offset, (UInt32)length);
					#else
        ...
        private static void CopyRawFromStream(Stream source, ProtoWriter writer)
        {
            ...
            if (writer.flushLock == 0)
            {
                ...
                {
					#if OPTIMIZATION_NETWORK
					writer._destBuf.Write(buffer, 0, (UInt32)bytesRead);
					#else
...
//			if (!dest.CanWrite) throw new ArgumentException("Cannot write to stream", "dest");
        ...
        internal static void Flush(ProtoWriter writer)
        {
            ...
            {
				#if OPTIMIZATION_NETWORK
				writer._destBuf.Write(writer.ioBuffer, 0, (UInt32)writer.ioIndex);
				#else
