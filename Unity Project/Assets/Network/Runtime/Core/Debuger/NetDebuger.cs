...
namespace Engine.Network
{
    public static class NetDebuger
    {
        ...
        public static int GetJitterDelay()
        {
            if (IsNetJitter())
            {
                return Nave.Network.math.Random.Default.Range(JitterDelayMin, JitterDelayMax);
            }
            return 0;
        }
        ...
        {
            return EnableWeakNet && Nave.Network.math.Random.Default.Rnd() < JitterRate;
        }

        public static bool IsPacketLoss()
        {
            return EnableWeakNet && Nave.Network.math.Random.Default.Rnd() < PacketLossRate;
        }
