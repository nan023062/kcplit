...
namespace Engine.Network
{
    public static class NetDebuger
    {
        ...
        public static int GetJitterDelay()
        {
            if (IsNetJitter())
            {
                return Engine.Core.math.Random.Default.Range(JitterDelayMin, JitterDelayMax);
            }
            return 0;
        }
        ...
        {
            return EnableWeakNet && Engine.Core.math.Random.Default.Rnd() < JitterRate;
        }

        public static bool IsPacketLoss()
        {
            return EnableWeakNet && Engine.Core.math.Random.Default.Rnd() < PacketLossRate;
        }
