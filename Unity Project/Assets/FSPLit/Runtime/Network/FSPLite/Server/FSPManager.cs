...
using System.Text;
using Nave.FSPLit.Codec;
using Nave.FSPLit.Network.General.Server;

namespace Nave.FSPLit.Network.FSPLite.Server
{
    public class FSPManager
    {
        ...
        public void Dump()
        {
            ...
            var listGame = m_mapGame.ToDictionary();
        ...
        {
            var list = m_mapGame.ToList();
            var dir = m_mapGame.ToDictionary();
            int cnt = list.Count;
